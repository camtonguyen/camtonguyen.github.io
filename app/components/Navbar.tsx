    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <motion.div
          ...
          className="h-9 cursor-pointer font-bold text-2xl"
        >
          Cam To.
        </motion.div>

        <ul className="hidden lg:flex items-center gap-x-7 font-semibold text-black">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden fixed top-0 right-0 h-full w-full bg-white shadow z-40 text-black"
          >
            <button
              className="absolute top-5 right-5 text-2xl text-black"
